...
{
    public partial class SendRFQ_TKPP : Form
    {
        ...
        string LogRFQ;
        string logpath;
        public SendRFQ_TKPP(DataTable dt)
        {
            InitializeComponent();
            dtsource = dt;
        ...
        private void rbtnSend_Click(object sender, EventArgs e)
        {
            ...
            {            
                ...
                if (LogRFQ == "1")
                {
                    ...
                    LogOptions.Log(logpath,LogCategory.SendRFQButton, "SenddRFQ-TKPP dtsource.Rows.Count  greater 0" + dtsource.Rows.Count);                    
                }
                ...
                {                                     
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        if (isSelected)
                        {
                            ...
                            dt.Rows.Add(row.Cells[1].Value, row.Cells[2].Value, row.Cells[3].Value, row.Cells[4].Value, row.Cells[5].Value, row.Cells[6].Value, row.Cells[7].Value, row.Cells[8].Value, row.Cells[9].Value, row.Cells[10].Value, row.Cells[11].Value, row.Cells[12].Value, row.Cells[13].Value, row.Cells[14].Value, row.Cells[15].Value, row.Cells[16].Value, row.Cells[17].Value, row.Cells[18].Value, row.Cells[19].Value, row.Cells[20].Value, row.Cells[21].Value, row.Cells[22].Value, row.Cells[23].Value, row.Cells[24].Value, row.Cells[25].Value, row.Cells[26].Value, row.Cells[27].Value, row.Cells[28].Value, row.Cells[29].Value, row.Cells[30].Value, row.Cells[31].Value, row.Cells[32].Value, row.Cells[33].Value, row.Cells[34].Value, row.Cells[35].Value, row.Cells[36].Value, row.Cells[37].Value, row.Cells[38].Value, row.Cells[39].Value, row.Cells[40].Value, row.Cells[41].Value, row.Cells[42].Value, row.Cells[43].Value, row.Cells[44].Value, row.Cells[45].Value);
                        }                      
                    }
                    dt.AcceptChanges();                  
                    dtnew = dt;
